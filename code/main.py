...
#                 val_transforms = val_transforms)
    ...
    for f in fraction_of_train_data:
        load_and_run(save_path="/home/omo23/Documents/segmentation-project/saved-tests/"+str(f*60)+"-20-20-no-transform",
                tr_va_split = [60,20,20],
                fraction_of_data = f,
        ...
        load_and_run(save_path="/home/omo23/Documents/segmentation-project/saved-tests/"+str(f*60)+"-20-20-elastic-noise-transform",
                tr_va_split = [60,20,20],
                fraction_of_data = f,
                number_of_epochs = 300,
